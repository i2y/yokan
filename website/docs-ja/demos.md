...
<img src="images/demos/dialect.png" width="360">
...
<img src="images/demos/closures.png" width="360">
...
<img src="images/demos/bytes.png" width="360">
...
<img src="images/demos/widgets.png" width="720">
...
??? note "widgets.py"
    ...
    The chrome is three of them. A `split` holds the pages beside the
    page, its left pane is a `list_view` you pick from, and the right one
    is a `scroll_view`. So the first three widgets are the ones you use
    to look at the rest.

    A verification script walks the pages by name — `select:Input` picks
    from the app's FIRST chooser, which is that list — and everything a
    page puts on the screen is numbered after it (`select@1:` and up).
    """
    import os
    import sys
    ...
    def view() -> None:
        with column(grow=1.0):
            ...
            with row(grow=1.0):
                ...
                divider()
                # A scroll_view takes a height rather than a share of the
                # row, so the column around it takes the width that is left
                # and the two panes are given the same height.
                # A row centres what it holds, so the pane is given the same
                # height as the list beside it and its page stacks from the
                # top of it.
...
<img src="images/demos/transcript.png" width="360">
...
<img src="images/demos/contextmenu.png" width="360">
