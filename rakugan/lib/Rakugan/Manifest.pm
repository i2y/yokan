...
our @ROWS = (
    ...
    { id => 12, module => 'sqlite', name => 'exec', class => 'Sqlite', fn => 'exec', ret => 'int', ret_ty => 'Int', sig => 'path: String, sql: String', kinds => ['str', 'str'], try => 1 },
    { id => 13, module => 'sqlite', name => 'query_text', class => 'Sqlite', fn => 'queryText', ret => 'strs', ret_ty => 'List<String>', sig => 'path: String, sql: String', kinds => ['str', 'str'], try => 1 },
    ...
    { id => 17, module => 'sqlite', name => 'exec', class => 'Sqlite', fn => 'execWith', ret => 'int', ret_ty => 'Int', sig => 'path: String, sql: String, params: List<String>', kinds => ['str', 'str', 'list'], try => 1 },
    { id => 18, module => 'sqlite', name => 'query_text', class => 'Sqlite', fn => 'queryTextWith', ret => 'strs', ret_ty => 'List<String>', sig => 'path: String, sql: String, params: List<String>', kinds => ['str', 'str', 'list'], try => 1 },
    ...
    { id => 22, module => 'sqlite', name => 'query_rows', class => 'Sqlite', fn => 'queryRows', ret => 'rows', ret_ty => 'List<List<String>>', sig => 'path: String, sql: String', kinds => ['str', 'str'], try => 1 },
    { id => 23, module => 'sqlite', name => 'query_rows', class => 'Sqlite', fn => 'queryRowsWith', ret => 'rows', ret_ty => 'List<List<String>>', sig => 'path: String, sql: String, params: List<String>', kinds => ['str', 'str', 'list'], try => 1 },
    ...
    { id => 39, module => 'http', name => 'post_text', class => 'Http', fn => 'postTextAs', ret => 'str', ret_ty => 'String', sig => 'url: String, body: String, contentType: String', kinds => ['str', 'str', 'str'], try => 1 },
    ...
    { id => 42, module => 'jsondoc', name => 'get_text', class => 'Jsondoc', fn => 'getText', ret => 'str', ret_ty => 'String', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    { id => 43, module => 'jsondoc', name => 'get_int', class => 'Jsondoc', fn => 'getInt', ret => 'int', ret_ty => 'Int', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    { id => 44, module => 'jsondoc', name => 'get_float', class => 'Jsondoc', fn => 'getFloat', ret => 'num', ret_ty => 'Float', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    { id => 45, module => 'jsondoc', name => 'get_bool', class => 'Jsondoc', fn => 'getBool', ret => 'bool', ret_ty => 'Bool', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    { id => 46, module => 'jsondoc', name => 'length', class => 'Jsondoc', fn => 'length', ret => 'int', ret_ty => 'Int', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    { id => 47, module => 'jsondoc', name => 'has', class => 'Jsondoc', fn => 'has', ret => 'bool', ret_ty => 'Bool', sig => 'src: String, path: String', kinds => ['str', 'str'], pure => 1, try => 1 },
    ...
    { id => 50, module => 'clock', name => 'format_ms', class => 'Clock', fn => 'formatMs', ret => 'str', ret_ty => 'String', sig => 'ms: Int, fmt: String', kinds => ['int', 'str'], try => 1 },
    { id => 51, module => 'clock', name => 'format_local_ms', class => 'Clock', fn => 'formatLocalMs', ret => 'str', ret_ty => 'String', sig => 'ms: Int, fmt: String', kinds => ['int', 'str'], try => 1 },
    { id => 52, module => 'clock', name => 'local_offset_minutes', class => 'Clock', fn => 'localOffsetMinutes', ret => 'int', ret_ty => 'Int', sig => 'ms: Int', kinds => ['int'], try => 1 },
);
