...
our @ROWS = (
    { id => 1, module => 'fs', name => 'read_text', class => 'Fs', fn => 'readText', ret => 'str', ret_ty => 'String', sig => 'path: String', kinds => ['str'] },
    ...
    { id => 14, module => 'sqlite', name => 'query_int', class => 'Sqlite', fn => 'queryInt', ret => 'int', ret_ty => 'Int', sig => 'path: String, sql: String', kinds => ['str', 'str'] },
    ...
    { id => 19, module => 'sqlite', name => 'query_int', class => 'Sqlite', fn => 'queryIntWith', ret => 'int', ret_ty => 'Int', sig => 'path: String, sql: String, params: List<String>', kinds => ['str', 'str', 'list'] },
    ...
    { id => 35, module => 'http', name => 'get_text', class => 'Http', fn => 'getText', ret => 'str', ret_ty => 'String', sig => 'url: String', kinds => ['str'] },
    ...
    { id => 37, module => 'http', name => 'get_text', class => 'Http', fn => 'getTextTimeout', ret => 'str', ret_ty => 'String', sig => 'url: String, timeoutMs: Int', kinds => ['str', 'int'] },
    { id => 38, module => 'http', name => 'post_text', class => 'Http', fn => 'postText', ret => 'str', ret_ty => 'String', sig => 'url: String, body: String', kinds => ['str', 'str'] },
