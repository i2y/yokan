...
['start', 'counter',
 ...
 '基本形。アプリはクラスで、状態はそのフィールド、ハンドラはそのフィールドが見える無名サブルーチン'],
['start', 'control',
...
['state', 'lookup',
 ...
 'アプリが持つハッシュ。既定値つきの読み出し、鍵の有無の確認、ウィンドウを開けたまま増やす'],
['state', 'points',
...
['look', 'styled',
 ...
 '見た目をひとところに。キーワードのハッシュを要素に渡し、`theme` でパネルごと切り替える'],
['look', 'badges',
...
['look', 'loading',
 ...
 '満ちていくバーの 3 つの形と、終わりの見えない仕事のための行き来する表示'],
['look', 'filter',
...
['perl', 'reader',
 ...
 '入れ子の JSON を経路で読む。ファイルに書いて読み直すので、両方の実行が同じバイト列を読む'],
['perl', 'dbnotes',
