...
`rakugan build` は、書いた Perl を [pixie](https://github.com/i2y/yokan/blob/main/docs/PIXIE.md) に翻訳し、Zed エディタを支える **gpui** の上に組んだ pixie のエンジンと結びます。
...
そこから外れる書き方は[Rakugan が断る書き方](tour-ship.md#rakugan-が断る書き方)に挙げてあります。
