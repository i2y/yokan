...
- [データベース](#データベース)
- [タイマー、ウィンドウの外の仕事、スレッド](#タイマーウィンドウの外の仕事スレッド)
- [書いているあいだ](#書いているあいだ)
...
`key_down` は今押されているかどうかを、`key_pressed` は前の frame から今までのあいだに押されたかどうかを答えます（押しっぱなしでも、答えるのは一度だけです）。
