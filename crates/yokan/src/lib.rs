...
#[pyfunction(signature = (value, width=0.0, height=0.0, label=String::new(), indeterminate=false, tooltip=String::new()))]
fn progress(value: f64, width: f64, height: f64, label: String, indeterminate: bool, tooltip: String) -> Reg {
    Reg::tip(&tooltip, Element::ProgressBar {
        value,
        width,
        height,
        label: Str::from(label),
