...
gate stdlib  python3 yokan_gate.py gate demo/stdlib.py --script "click:measure,click:stats,click:due,click:roll,click:parse,click:stamp,click:write,dump,click:write list,dump"
